            ...
            <div class="col-4">
                <template v-for="(chat, index) in chats">
                    <div v-on:click="showChat(index)"
                        ...
                        <span
                            class="nurse-name">{{ nurses[index][0].first_name + ' ' + nurses[index][0].last_name}}</span>
                    </div>
                </template>
            </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            getPrivateChats() {
                axios.get('get-clients-chats/' + this.client.id)
                    .then((response) => {
            ...
            showChat(index) {
                ...
                this.active = index;
                this.nurse = this.nurses[index][0];
            },
            formatDate(date) {
