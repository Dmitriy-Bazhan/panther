...
<table>
    ...
    <tr>
        <th class="booking-info"> @lang('mail-message.you_take_new_booking_from')&nbsp;{{ ' ' . $client->first_name . ' '  . $client->last_name }}</th>
    </tr>
    ...
    <tr>
        <th>
            <a href="{{ $url }}">
                <button class="main-slider--subtitle">@lang('mail-message.go_to_my_bookings')</button>
            </a>
        </th>
    </tr>
</table>
